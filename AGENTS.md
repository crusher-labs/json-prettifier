# AGENTS.md - JSON Prettifier/Minifier

Single-purpose static tool: Format, validate, minify, and beautify JSON instantly. Part of the crusher-labs **static tools line** (frozen). Hosted on GitHub Pages at https://crusher-labs.github.io/json-prettifier/
