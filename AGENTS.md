...
Single-purpose static tool, built as a **world page**: green-bar printout. Format, validate and minify JSON as you type, printed line by line on green-bar line-printer paper; errors print in ribbon red; sort keys; copy. Part of the crusher-labs static tools line. Hosted on GitHub Pages at https://crusher-labs.github.io/json-prettifier/
